...
public class DayViewFacade {
    ...
    private @ColorInt int eventColor = Color.BLUE;
    ...
    public void setEventColor(@ColorInt int eventColor) {
        this.eventColor = eventColor;
    }

    private boolean containsDotSpan(@NonNull DotSpan dotSpan){
        if (dotSpan != null){
            for (Span span :spans) {
                if (dotSpan.color == ((DotSpan)span.span).color) return true;
            }
        }
        return false;
    }
