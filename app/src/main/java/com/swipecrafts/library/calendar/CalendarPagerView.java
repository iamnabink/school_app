...
abstract class CalendarPagerView extends ViewGroup implements View.OnClickListener {
    ...
    private static CalendarDay tempWorkingCalendar = CalendarDay.today();
    private CalendarDay firstViewDay;
    private CalendarDay minDate = null;
    private CalendarDay maxDate = null;
    private int firstDayOfWeek;
    protected int numOfRows = DEFAULT_MAX_WEEKS;
    ...
    public CalendarPagerView(@NonNull MaterialCalendarView view,
        ...
        this.numOfRows = firstViewDay.getActiveCalendar().countWeek();
    ...
    private void buildWeekDays(CalendarDay calendar) {
    ...
    protected void addDayView(Collection<DayView> dayViews, CalendarDay calendar) {
        CalendarDay day = (CalendarDay) calendar.clone();
    ...
    protected CalendarDay resetAndGetWorkingCalendar() {
        tempWorkingCalendar = CalendarDay.fromToMonth(getFirstViewDay());
        int delta = tempWorkingCalendar.getActiveCalendar().getDayOfWeek();
        tempWorkingCalendar.subtractDay(delta);
    ...
    protected abstract void buildDayViews(Collection<DayView> dayViews, CalendarDay calendar);
