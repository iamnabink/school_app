 ...
 */
public class ImageSliderTransformer implements ViewPager.PageTransformer {
    private static final float MIN_SCALE_DEPTH = 0.75f;
    private static final float MIN_SCALE_ZOOM = 0.85f;
    private static final float MIN_ALPHA_ZOOM = 0.5f;
    private static final float SCALE_FACTOR_SLIDE = 0.85f;
    private static final float MIN_ALPHA_SLIDE = 0.35f;
    private static final float MIN_FADE_SCALE = 0.75f;

    private final TransformType mTransformType;

    public ImageSliderTransformer(TransformType transformType) {
